#!/bin/bash
#
# Run this on Cloud9 to increase size of the volume (which is quite small to start)
# From:
...
# Specify the desired volume size in GiB as a command line argument. If not specified, default to 24 GiB.
SIZE=${1:-24}
